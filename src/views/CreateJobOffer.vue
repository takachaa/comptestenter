			...
			<article>
				...
				<section id="step">
                  ...
                  v-bind:class="{ 'p-form__step--step1': pageStatus === 1,  
								...
								<li class="p-form__step__item">写真登録</li>
								<li class="p-form__step__item">募集概要</li>
								<li class="p-form__step__item">募集詳細１</li>
								<li class="p-form__step__item">募集詳細２</li>
							</ul>
						</div>
						<!--/contents-->
					</div>
...
import Registration1 from '@/components/JobRegistration1.vue'
import Registration2 from '@/components/JobRegistration2.vue'
import Registration3 from '@/components/JobRegistration3.vue'
import Registration4 from '@/components/JobRegistration4.vue'
import Registration5 from '@/components/JobRegistration5.vue'
