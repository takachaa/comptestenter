					...
					<div class="l-main__section">
						...
						<div class="l-main__contents">				
							...
							<!-- <div class="u-fixed u-fixed--title">
								<router-link :to="{ name: 'ManageJobOffer', params: { value: jobId }}" class="p-offertitle"></router-link >
							</div> -->

							<router-link :to="{ name: 'ManageJobOffer', params: { value: jobId }}" class="p-offertitle">募集案件管理</router-link >		
							<!--job-->
							<div class="p-offer p-offer--detail">
								<div class="p-offer__thumbnail">
									...
									<div class="u-align--center u-margin--bottom10 u-padding--top10">
										<!-- <a href="recruit_registration1.html" class="c-btn__detail">登録写真を編集する</a> -->
										<router-link :to="{ name: 'EditJobOffer1' }" class="c-btn__detail">登録写真を編集する</router-link>
									</div>
								</div>
								...
								<div class="p-offer__detail p-offer__detail--details">
									...
									<div class="u-align--center u-margin--bottom20">
										<!-- <a href="recruit_registration2.html" class="c-btn__detail">募集概要を編集する</a> -->
										<router-link :to="{ name: 'EditJobOffer2' }" class="c-btn__detail">募集概要を編集する</router-link>
									</div>
									...
									<div class="u-align--center u-padding--top5 u-margin--bottom10">
										<router-link :to="{ name: 'EditJobOffer3' }" class="c-btn__detail">募集詳細を編集する</router-link>
									</div>
